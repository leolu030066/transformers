...
"""
Processor class for RobustSAM.
"""

# Copied from transformers.models.sam.processing_sam with Sam->RobustSam
...
class RobustSamProcessor(ProcessorMixin):
    r"""
    Constructs a RobustSAM processor which wraps a RobustSAM image processor and an 2D points & Bounding boxes processor into a
    single processor.

    [`RobustSamProcessor`] offers all the functionalities of [`RobustSamImageProcessor`]. See the docstring of
    [`~RobustSamImageProcessor.__call__`] for more information.

    Args:
        image_processor (`RobustSamImageProcessor`):
            An instance of [`RobustSamImageProcessor`]. The image processor is a required input.
    """

    attributes = ["image_processor"]
    image_processor_class = "RobustSamImageProcessor"
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        This method uses [`RobustSamImageProcessor.__call__`] method to prepare image(s) for the model. It also prepares 2D

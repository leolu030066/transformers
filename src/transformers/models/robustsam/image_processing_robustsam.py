...
"""Image processor class for RobustSAM."""

# Copied from transformers.models.sam.image_processing_sam with Sam->RobustSam
...
# Copied from transformers.models.sam.image_processing_sam.SamImageProcessor with Sam->RobustSam
class RobustSamImageProcessor(BaseImageProcessor):
    r"""
    Constructs a RobustSAM image processor.

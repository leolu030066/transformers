...
"""
TensorFlow RobustSAM model. This file was mostly generated by auto-translation from the PyTorch original. In the event of a
...
@dataclass
class TFRobustSamVisionEncoderOutput(ModelOutput):
    """
    ...
    encoder_features: Tuple[tf.Tensor, ...] | None = None
...
@dataclass
class TFRobustSamImageSegmentationOutput(ModelOutput):
    """

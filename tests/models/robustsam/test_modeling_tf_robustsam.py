...
"""Testing suite for the TensorFlow RobustSAM model."""
...
from transformers import RobustSamConfig, RobustSamMaskDecoderConfig, RobustSamPromptEncoderConfig, RobustSamVisionConfig
...
if is_tf_available():
    ...
    from transformers import RobustSamProcessor, TFRobustSamModel
...
class TFRobustSamPromptEncoderTester:
    def __init__(
        self,
        hidden_size=32,
        input_image_size=24,
...
class TFRobustSamMaskDecoderTester:
    def __init__(
        self,
        hidden_size=32,
        hidden_act="relu",
...
class TFRobustSamModelTester:
    def __init__(
        ...
        self.prompt_encoder_tester = TFRobustSamPromptEncoderTester()
        self.mask_decoder_tester = TFRobustSamMaskDecoderTester()
    ...
    def create_and_check_model(self, config, pixel_values):
        model = TFRobustSamModel(config=config)
...
@require_tf
class TFRobustSamModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    """
    ...
    all_model_classes = (TFRobustSamModel,) if is_tf_available() else ()
    pipeline_model_mapping = (
        {"feature-extraction": TFRobustSamModel, "mask-generation": TFRobustSamModel} if is_tf_available() else {}
    )
    test_pruning = False
    ...
    def setUp(self):
        self.model_tester = TFRobustSamModelTester(self)
